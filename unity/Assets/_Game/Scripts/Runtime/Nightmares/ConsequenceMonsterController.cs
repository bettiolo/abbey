...
{
    /// <summary>
    /// The shared controller for consequence nightmares (Hunger Wight, Dead Worker, Grave
    /// Crawler, Chain Hound, Faceless Saint, plus the forest-misdirection set). Their hunt behaviour is exactly
    ...
    /// controller carries each species type and per-type stats
