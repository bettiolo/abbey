...
3. Menu **Tools → Abbey → Build Campaign Scenes (Start Map 1)** for the complete two-map
   campaign. Use **Build Prototype Scene** or **Build Map 2 Scene** for focused testing
   (scenes are generated by code here, never hand-authored), then press **Play**.
