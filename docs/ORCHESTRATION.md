...
3. Push the integration branch (`git push -u origin main`) after every successful
   merge batch. All work lands on `main`, the repository default (renamed from the
   original session branch on 2026-07-02).
